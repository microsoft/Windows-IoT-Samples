...
You can find the source code for this sample in our [git repository](...\...\WiFiConnector). Clone the project to your machine and open the project from Visual Studio.

The code for the WiFi Connect sample can be found under: [\WiFiConnector\CS](...\...\WiFiConnector\CS)
