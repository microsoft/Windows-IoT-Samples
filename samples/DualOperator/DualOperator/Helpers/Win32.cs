...
namespace DualOperator.Helpers
{
    static public class Win32
    {
        ...
        public static void DeviceAudit(string Filename)
        {
            ...
            if (GetRawInputDeviceList(IntPtr.Zero, ref deviceCount, (uint)dwSize) == 0)
            {
                ...
                for (var i = 0; i < deviceCount; i++)
                {
                    ...
                    // On 64 bit Windows when compiling against .Net > 3.5 using .ToInt32 you will generate an arithmetic overflow. Leave as it is for 32bit/64bit applications
